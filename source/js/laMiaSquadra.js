...
export function mostraLaMiaSquadra() {
  ...
  vistaLaMiaSquadra.querySelector("#nome-squadra").textContent = `${UTENTELOGGATO.nomeSquadraUtenteLoggato}`;
  vistaLaMiaSquadra.querySelector("#nome-presidente").textContent = `${toCapitalize(UTENTELOGGATO.presidenteUtenteLoggato.getNomePresidente)}`;
  vistaLaMiaSquadra.querySelector("#crediti-residui").innerHTML = `<img src="./Assets/image/generici/dollar.png"/> ${UTENTELOGGATO.presidenteUtenteLoggato.getCreditiResidui}`;
  vistaLaMiaSquadra.querySelector("#totale-portieri").textContent = `Por.${UTENTELOGGATO.presidenteUtenteLoggato.getContaP}`;
...
const containerCentrocampisti = document.getElementById("container-centrocampisti");
...
UTENTELOGGATO.presidenteUtenteLoggato.getTuttiGliSlot.forEach((element,index) => {
    ...
    switch (element.getDatiGiocatore.getRuolo) {
        ...
        case "D":
            ...
            break;
        case "C":
            containerCentrocampisti.appendChild(creaCardGiocatore(element,index,0));
            break;
        case "A":
